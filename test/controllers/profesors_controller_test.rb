...
class ProfesorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post profesors_url, params: { profesor: { carrera: @profesor.carrera, departamento: @profesor.departamento, nombre: @profesor.nombre } }
    end
  ...
  test "should update profesor" do
    patch profesor_url(@profesor), params: { profesor: { carrera: @profesor.carrera, departamento: @profesor.departamento, nombre: @profesor.nombre } }
