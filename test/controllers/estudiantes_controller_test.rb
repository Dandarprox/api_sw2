...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { carrera: @estudiante.carrera, departamento: @estudiante.departamento, nombre: @estudiante.nombre, semestre: @estudiante.semestre } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { carrera: @estudiante.carrera, departamento: @estudiante.departamento, nombre: @estudiante.nombre, semestre: @estudiante.semestre } }
